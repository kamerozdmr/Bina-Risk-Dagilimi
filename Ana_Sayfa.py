...
if authentication_status:
        ...
        st.write("[Github Repo](https://github.com/kamerozdmr/Bina-Risk-Dagilimi)")

        if "bina_tipi" not in st.session_state:
                st.session_state["bina_tipi"] = "Bina tipi seçilmedi"

        if "sistem_tipi" not in st.session_state: 
                st.session_state["sistem_tipi"] = "Yapısal sistem tipi seçilmedi"
