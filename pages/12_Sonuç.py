...
try:
    if st.session_state["bina_tipi"] == "Betonarme":
        ...
        with col1:
            ...
            st.write("---")
            st.write("Aşağıdaki bölümden parametrelerin doğruluğunu kontrol ediniz ve kaydediniz.")
        ...
        ########################################
        st.write("Parametreleri ve sonuçları kontrol ettikten sonra kaydediniz.")
